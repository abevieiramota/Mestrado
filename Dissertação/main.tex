...
% ---
\titulo{Aplicação de aprendizado de máquina ao problema de evasão de estudantes da UFC}
...
\input{./capitulos/aprendizado.tex}
\input{./capitulos/evasao.tex}
% ---
